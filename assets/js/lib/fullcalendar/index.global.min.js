...
var FullCalendar = (function (e) {
    ...
    function _r() {
        return (
            null === xr &&
                (xr = (function () {
                    let e = document.createElement('div');
                    He(e, { position: 'absolute', top: -1e3, left: 0, border: 0, padding: 0, overflow: 'scroll', direction: 'rtl' }),
                        (e.innerHTML = '<div></div>'),
                        document.body.appendChild(e);
    ...
    class ei {
        ...
        adjustActiveRange(e) {
            let { dateEnv: t, usesMinMaxTime: n, slotMinTime: r, slotMaxTime: i } = this.props,
                { start: s, end: o } = e;
            return (
                n && (mt(r) < 0 && ((s = Lt(s)), (s = t.add(s, r))), mt(i) > 1 && ((o = Lt(o)), (o = Pt(o, -1)), (o = t.add(o, i)))),
                { start: s, end: o }
            );
        }
        buildRangeFromDuration(e, t, n, r) {
            ...
            return (
                mt(n) <= 1 && this.isHiddenDay(i) && ((i = this.skipHiddenDays(i, t)), (i = Lt(i))),
                c(),
    ...
    function ti(e, t, n) {
        n.emitter.trigger(
            'select',
            Object.assign(Object.assign({}, ni(e, n)), { jsEvent: t ? t.origEvent : null, view: n.viewApi || n.calendarApi.view })
        );
    }
    function ni(e, t) {
        let n = {};
    ...
    class Bi {
        ...
        diffWholeYears(e, t) {
            ...
            return Xt(e) === Xt(t) && n.getMarkerDay(e) === n.getMarkerDay(t) && n.getMarkerMonth(e) === n.getMarkerMonth(t)
    ...
    class ji {
        ...
        isInsertionValid(e, t) {
            return (
                (-1 === this.maxCoord || e.levelCoord + t.thickness <= this.maxCoord) && (-1 === this.maxStackCnt || e.stackCnt < this.maxStackCnt)
            );
        }
        ...
        insertEntryAt(e, t) {
            ...
            -1 === t.lateral ? (Fi(r, t.level, t.levelCoord), Fi(n, t.level, [e])) : Fi(n[t.level], t.lateral, e),
            ...
            if (i) {
                ...
                r &&
                    i(
                        Object.assign(
                            Object.assign(
                                { id: this.id, isActive: e, containerEl: this.base, reportNewContainerEl: this.handleEl, generatorMeta: r },
                                n
                            ),
    ...
    class as extends D {
        ...
        componentDidMount() {
            ...
            null === (t = (e = this.props).didMount) ||
                void 0 === t ||
                t.call(e, Object.assign(Object.assign({}, this.props.renderProps), { el: this.rootEl || this.base }));
        }
        componentWillUnmount() {
            var e, t;
            ...
            return p(
                as,
                {
                    ...
                    elAttrs: Object.assign(
                        { role: 'columnheader', colSpan: i.colSpan, 'data-date': a.isDisabled ? void 0 : Jt(s) },
                        i.extraDataAttrs
                    ),
                    renderProps: u,
    ...
    class hs extends D {
        ...
        computeTiming() {
            ...
            return (
                (s = Math.min(864e5, s)), { currentState: { nowDate: r, todayRange: fs(r) }, nextState: { nowDate: i, todayRange: fs(i) }, waitMs: s }
            );
        }
        setTimeout() {
        ...
        render() {
            ...
            return p(hs, { unit: 'day' }, (e, o) =>
                p(
                    ...
                    t.map((e) =>
                        r
                            ? p(cs, { key: e.toISOString(), date: e, dateProfile: n, todayRange: o, colCnt: t.length, dayHeaderFormat: s })
            ...
            !(
                ...
                !(function (e, t, n, r) {
                    ...
                    let d =
                            ...
                            { defs: g.defs, instances: At(g.instances, (e) => !p[e.instanceId]) }),
                        u = d.defs,
                        h = d.instances,
    ...
    function Vs(e, t) {
        ...
        for (let r of e) {
            let e = r.span || 1;
            for (let i = 0; i < e; i += 1)
                n.push(p('col', { style: { width: 'shrink' === r.width ? Gs(t) : r.width || '', minWidth: r.minWidth || '' } }));
        }
        return p('colgroup', {}, ...n);
    }
    function Gs(e) {
    ...
    class Js extends Xr {
        ...
        renderSection(e, t, n) {
            return 'outerContent' in e
                ...
                : p('tr', { key: e.key, role: 'presentation', className: Ys(e, this.props.liquid).join(' ') }, this.renderChunkTd(e, t, e.chunk, n));
        }
            ...
            if (e instanceof li) {
                ...
                return (
                    this.getCurrentData().eventStore.defs[t.defId] ||
                        (this.dispatch({ type: 'ADD_EVENTS', eventStore: Nn({ def: t, instance: n }) }), this.triggerEventAdd(e)),
                    e
                );
            }
            let n,
    ...
    function Wo(e) {
        let t = 'function' == typeof e ? { component: e } : e,
            { component: n } = t;
        return (
            t.content ? (n = Lo(t)) : !n || n.prototype instanceof Xr || (n = Lo(Object.assign(Object.assign({}, t), { content: n }))),
    ...
    class ha {
        ...
        processRawCalendarOptions(e, t) {
            let { locales: n, locale: r } = xn([En, e, t]),
                ...
                l = (this.currentCalendarOptionsRefiners = Object.assign(
                    Object.assign(Object.assign(Object.assign(Object.assign({}, bn), Sn), An), a.listenerRefiners),
                    a.optionRefiners
                )),
                c = {},
                d = xn([En, o, e, t]),
                ...
                g = !1;
            for (let e in d)
                -1 === this.optionsForRefining.indexOf(e) && (d[e] === h[e] || (Dn[e] && e in h && Dn[e](h[e], d[e])))
                    ? (u[e] = f[e])
                    : l[e]
                    ? ((u[e] = l[e](d[e])), (g = !0))
                    : (c[e] = h[e]);
        ...
        processRawViewOptions(e, t, n, r, i) {
            let s = xn([En, e.optionDefaults, n, r, e.optionOverrides, i]),
                o = Object.assign(
                    Object.assign(Object.assign(Object.assign(Object.assign(Object.assign({}, bn), Sn), An), Rn), t.listenerRefiners),
                    t.optionRefiners
                ),
                a = {},
    ...
    class xa extends Gi {
        ...
        triggerEvent(e, t, n) {
            ...
            (t && !r.isValidSegDownEl(t.target)) ||
                i.emitter.trigger(e, { el: n, event: new li(i, s.eventRange.def, s.eventRange.instance), jsEvent: t, view: i.viewApi });
        }
    }
    class _a extends Zr {
        constructor() {
    ...
    class Ba {
        ...
        updateElPosition() {
            this.sourceEl &&
                this.isVisible &&
                He(this.getMirrorEl(), { left: this.sourceElRect.left + this.deltaX, top: this.sourceElRect.top + this.deltaY });
        }
        getMirrorEl() {
                        ...
                        i === s || (t.editable && t.droppable)
                            ? ((o = (function (e, t, n) {
                                  let r = e.dateSpan,
                                      ...
                                      a = {};
                                  r.allDay !== i.allDay &&
                                      ((a.allDay = i.allDay), (a.hasEnd = t.context.options.allDayMaintainDuration), i.allDay && (s = Lt(s)));
                              ...
                              o &&
                                  ...
                                  (c.mutatedEvents = a),
                                  Cs(c, e.dateProfile, s) || ((l = !0), (o = null), (a = null), (c.mutatedEvents = { defs: {}, instances: {} }))))
                            : (s = null);
                    }
                    ...
                    super(e),
                        ...
                        (this.handleHitUpdate = (e, t, n) => {
                            ...
                            a &&
                                ...
                                (d.mutatedEvents = l),
                                Cs(d, e.dateProfile, r) || ((c = !0), (a = null), (l = null), (d.mutatedEvents = null))),
            ...
            return p(
                ...
                (s, a) =>
                    p(
                        ...
                        t.showWeekNumber &&
                            p(uo, { elTag: 'a', elClasses: ['fc-daygrid-week-number'], elAttrs: Cr(e, o, 'week'), date: o, defaultFormat: ul }),
    ...
    function gl(e, t, n, r, i, s, o) {
        ...
        let d = a.addSegs(l),
            u = a.toRects(),
            {
                ...
                for (let e = 0; e < n.length; e += 1) {
                    ...
                    for (let r of a) {
                        let i = t[r.index];
                        l.push({ seg: pl(i, e, e + 1, n), isVisible: !0, isAbsolute: !1, absoluteTop: r.levelCoord, marginTop: r.levelCoord - c }),
        ...
        for (let e of c) {
            ...
            for (let t = e.firstCol; t <= e.lastCol; t += 1)
                h[t].push({ seg: pl(e, t, t + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
        ...
        for (let t of d) {
            ...
            for (let e = r.start; e < r.end; e += 1)
                (p[e] += 1), h[e].push({ seg: pl(n, e, e + 1, o), isVisible: !1, isAbsolute: !1, absoluteTop: 0, marginTop: 0 });
        }
            ...
            if (i)
                for (let o of e) {
                    ...
                    s.push(
                        p(
                            'div',
                            { key: Ci(o.eventRange), className: 'fc-daygrid-bg-harness', style: e },
    ...
    class yl extends Jr {
        ...
        componentDidMount() {
            ...
            (this.rootEl = e ? e.closest('.fc-daygrid-body') : null),
                this.rootEl && this.context.registerInteractiveComponent(this, { el: this.rootEl, isHitComboAllowed: this.props.isHitComboAllowed });
        }
        componentWillUnmount() {
        ...
        renderSimpleLayout(e, t, n) {
            ...
            return (
                ...
                p(
                    ...
                    p(Js, { liquid: !i.isHeightAuto && !i.forPrint, collapsibleWidth: i.forPrint, cols: [{ width: 'shrink' }], sections: s })
                )
            );
        }
                                    ...
                                    p(
                                        ...
                                        p(hs, { unit: f ? 'minute' : 'day' }, (e) => {
                                            ...
                                            return 'number' == typeof t
                                                ? p(no, { elClasses: ['fc-timegrid-now-indicator-arrow'], elStyle: { top: t }, isAxis: !0, date: e })
                                                : null;
                                        })
                                    )
                                )
        ...
        updateSizing() {
            ...
            if (t.onCoords && null !== t.clientWidth) {
                this.rootElRef.current.offsetHeight &&
                    t.onCoords(
                        new Hl(
                            new Br(this.rootElRef.current, ((n = this.slatElRefs.currentMap), t.slatMetas.map((e) => n[e.key])), !1, !0),
            ...
            return p(
                ...
                b.map((e) => {
                    ...
                    return p(
                        ...
                        p(
                            Xl,
                            Object.assign({ seg: o, isDragging: n, isResizing: r, isDateSelecting: i, isSelected: c === h, isShort: b }, Di(o, f, g))
                        )
                    );
                })
            );
        ...
        renderFillSegs(e, t) {
            let { props: n, context: r } = this,
                i = Yl(e, n.date, n.slatCoords, r.options.eventMinHeight).map((r, i) => {
                    ...
                    return p(
                        'div',
                        { key: Ci(s.eventRange), className: 'fc-timegrid-bg-harness', style: Kl(r) },
        ...
        return p(
            ...
            e.map((e) => {
                ...
                return p(
                    ...
                    p(
                        Xl,
                        Object.assign({ seg: e, isDragging: !1, isResizing: !1, isDateSelecting: !1, isSelected: i === r, isShort: !1 }, Di(e, t, n))
                    )
                );
            })
        );
    ...
    class ec extends Xr {
        ...
        updateCoords() {
            ...
            e.onColCoords &&
                null !== e.clientWidth &&
                e.onColCoords(new Br(this.rootElRef.current, ((t = this.cellElRefs.currentMap), e.cells.map((e) => t[e.key])), !0, !1));
        }
    }
    class tc extends Jr {
        constructor() {
